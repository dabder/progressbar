...
class ProgressBarComponent extends HTMLElement {
  ...
  refresh() {
    ...
    const element = this.shadow.querySelector('.progress-bar')
  ...
  getPropertyValue(name) {
    return JSON.parse(this.getAttribute(name)).static
  }
}
...
zySdk.services.registry.registerComponent(Metadata, ProgressBarComponent)